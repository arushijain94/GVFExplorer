...
class TD:
    ...
    def get_sampling_policy(self):
        if self.type_target == 1:  # mixture policy as the sampling policy
            ...
            self.update_counter = int(self.update_counter % self.n_tar_policies)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_alpha", default=0.9, type=float, help="Learning Rate")
    parser.add_argument("--min_alpha", default=0.1, type=float, help="Learning Rate")
    parser.add_argument("--lr_decay_steps", default=50000, type=int, help="Learning Rate decay in these many steps")
    ...
    wandb_dir = f"{args.wandb_group}_{current_time}_{args.min_alpha}_{args.lr_decay_steps}_{args.type_target}_{args.seed}"
    ...
    for iter_ in range(num_iter):
        ...
        # if iter_% 1000 == 0 and args.type_target==0:
