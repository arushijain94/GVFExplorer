...
class MonteCarloValueEstimator:
    ...
    def simulate_episode(self, start_state, agent, env_reset_option, max_steps=200):
        # print("start state in sumulate episode:", start_state)
    ...
    def mc_compute_val(self, start_state, store_freq=100):
        val_of_state = 0.0
...
if __name__ == "__main__":
    ...
    mc = MonteCarloValueEstimator(args, env, args.env_id, args.seed, agent, env_args,
                                  args.run_save_loc, save_val_folder="true_val_random_states",num_episodes=50000)
