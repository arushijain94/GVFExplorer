...
def load_target_policy_and_state_val_dict(args):
    ...
    locs = [loc_1, loc_2, loc_3, loc_4] #, loc_3
    target_agents = []
    state_to_vals = []
...
if __name__ == "__main__":
    ...
    for global_step in range(args.total_timesteps):
        ...
        if plot_q_true_func == 1:
            ...
            running_agent.get_trajectories_agent(global_step, num_trajectories=4, policy_index=2)
            running_agent.get_trajectories_agent(global_step, num_trajectories=4, policy_index=3)
